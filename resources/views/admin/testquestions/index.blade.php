    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="ibox-tools">
                <a href="{{ route('admin.testquestions.create') }}" class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"><i class="fa fa-plus"></i> <strong>Create</strong></a>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-sm-12">
                                <form action="{{ route('admin.questions.index') }}" method="get" class="form-inline" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('admin.testquestions.index') }}" class="btn btn-default btn-sm">Reset</a>
                                    </div>
                                </form>
                            </div>
                        </div>
